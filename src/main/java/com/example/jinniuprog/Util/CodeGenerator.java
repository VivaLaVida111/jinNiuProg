package com.example.jinniuprog.Util;
...
public class CodeGenerator {
    ...
    private static void generate() {
        FastAutoGenerator.create("jdbc:mysql://101.37.246.72:3306/mock?serverTimezone=GMT%2B8", "root", "jinNIU123456!")
...
//                            .enableSwagger() // 开启 swagger 模式
                ...
                .packageConfig(builder -> {
                    builder.parent("com.example.jinniuprog") // 设置父包名
                            .moduleName("") // 设置父包模块名
